...
\vspace{0pt}
\centering
\includegraphics[width=\linewidth]{../exploratory_data_analysis/eda_output/fig_log_transformed_features.png}
\captionof{figure}{\footnotesize Log\textsubscript{1p}-transformation of the
...
\label{fig:pca}
\vspace{4pt}
\includegraphics[width=0.72\linewidth]{../exploratory_data_analysis/eda_output/fig_pca_loadings_heatmap.png}
\captionof{figure}{\footnotesize PCA feature loadings (PC1 \& PC2).}
\label{fig:pcaload}
\end{minipage}
